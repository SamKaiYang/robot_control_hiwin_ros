...
#     print("get_robot_motion_state:",Arm_state)
#     if Arm_state == 1:
#         if ItemNo==0:
#             positon = [0.0,36.8,11.35,-180,0,90]
...
if __name__ == '__main__':
    ...
    try:
        ...
        while(1):
            ...
            # # get current pos
            # Current_pos = robot_ctr.Get_current_position()
            # print("Current pos:",Current_pos)
            
            if Arm_state == 1:
                if ItemNo==0:
                    positon = [0.0,36.8,11.35,-180,0,90]
                    robot_ctr.Step_AbsLine_PosCmd(positon,1,50)
                    ItemNo = 1
                    #print("task:0")
                elif ItemNo==1:
                    positon = [0.0,46.8,11.35,-180,0,90]
                    ...
                    #robot_ctr.Step_AbsLine_PosCmd(positon,1,50)
                    robot_ctr.Step_AbsPTPCmd(positon)
                    # Rel_positon = [-5,0,0,0,0,0]
                    # robot_ctr.Step_RelLineCmd(Rel_positon)
                    # positon = [10.0,46.7,11.35,-180,0,90]
                    # #robot_ctr.Step_AbsLine_PosCmd(positon,1,50)
                    # robot_ctr.Step_AbsPTPCmd(positon)
                    # positon = [10.0,46.8,11.35,-180,0,90]
                    # #robot_ctr.Step_AbsLine_PosCmd(positon,1,50)
